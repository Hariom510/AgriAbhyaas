...
return (
    <Box>
        ...
        <Num>1.</Num>
        <Qst>
        <p>Circle Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. </p>
        </Qst>
        </FullQst>
        <BoxInside>
        <Option>
            <InsideOpt>
                ...
                <p><input type="radio" name='q1' value="true" onChange={(e)=>setIsOpen(e.target.value)} /> Option C</p>
