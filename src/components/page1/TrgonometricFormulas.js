...
function TrigonometricFormulas() {
...
return (
    <Box>
        ...
        <Num>1.</Num>
        <Qst>
        <p>Trigonometric Formulas Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. </p>
        </Qst>
        </FullQst>
        <BoxInside>
        <Option>
...
export default TrigonometricFormulas
